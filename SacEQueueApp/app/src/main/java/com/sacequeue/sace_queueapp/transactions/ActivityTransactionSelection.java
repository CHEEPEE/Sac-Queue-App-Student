...
import com.sacequeue.sace_queueapp.*;
import com.sacequeue.sace_queueapp.StudentTransactionDetailsDataMapModel;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Map;

public class ActivityTransactionSelection extends AppCompatActivity {
...
//    ArrayList<TransactionOptionDataModel> selectedTransaction = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = ActivityTransactionSelection.this;
        ...
        //transactions
        transactionList.setLayoutManager(new GridLayoutManager(context,1));
...
//        Message mMessage = new Message("Hey", "09164137221");
//        sendTransaction.sendNewMessage(mMessage,Transaction.NO_THREAD_ID);

//        Settings settings = new Settings();
//        settings.setUseSystemSending(true);
//        Transaction transaction = new Transaction(context, settings);
//        Message message = new Message("Send This", "0916413722");
//        transaction.sendNewMessage(message, Transaction.NO_THREAD_ID);
    ...
    private void saveTransaction(final String studentNumber, final String queueNumber, final String mobilebnumber) {
        ...
        com.sacequeue.sace_queueapp.StudentTransactionDetailsDataMapModel transactionDetailsDataMapModel = new StudentTransactionDetailsDataMapModel(studentNumber,queueNumber,mobilebnumber);
    ...
    private void reqPermissionSMS(){
        if (ContextCompat.checkSelfPermission(context,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(ActivityTransactionSelection.this,
                    Manifest.permission.SEND_SMS)) {
                ActivityCompat.requestPermissions(ActivityTransactionSelection.this,
